...
class User(Base):
    ...
    googleassist = Column('googleassist' , Integer)
    alexa = Column('alexa',Integer)
...
##    inherit from the parent table device
    ...
    __mapper_args__ = {'ploymorphic_identity':'hub'
        }
...
##    inherit from the parent table device
    ...
    __mapper_args__ = {'ploymorphic_identity':'controller'
        }
